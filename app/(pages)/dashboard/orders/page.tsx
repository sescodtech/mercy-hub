...
function OrdersContent() {
  ...
  useEffect(() => {
    if (status === "unauthenticated") router.push("/sign-in?callbackUrl=/dashboard/orders");
  }, [status, router]);
                          ...
                          <div key={s} className="flex items-center gap-2 flex-shrink-0">
                            <div className="flex flex-col items-center gap-1">
                              ...
                              <span className={cn(
                                ...
                                isCurrent ? "text-[#d98c2a]" : isDone ? "text-neutral-600" : "text-neutral-300"
                              )}>
                                {sc.label}
                              </span>
                            </div>
                            {i < arr.length - 1 && (
                              <div className={cn(
                                "w-8 h-0.5 flex-shrink-0 mb-4",
                                isDone && statusOrder.indexOf(arr[i + 1]) <= currentIdx
                                  ? "bg-[#d98c2a]" : "bg-neutral-200"
                              )} />
                            )}
                          </div>
                        );
      ...
      <div className="bg-white border-b border-neutral-100">
        <div className="container-site py-5 flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-neutral-400 mt-0.5">Track and manage your orders</p>
          </div>
